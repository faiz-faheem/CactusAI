...
function App() {
  ...
  return (
    <div className={`App ${theme}`}>
        <div className="top">
          <span className='title'>Cactus AI</span>
        ...
        : <><div className="greet">
          <span className='colorGreet'>Hi, I am Cactus AI</span>
      ...
      <div className='info'>
      Cactus may display inaccurate info, including about people, so double-check its responses.<button className='infbtn'>Your privacy and Cactus Apps</button> 
      </div>
      </div>
    </div>
  )
